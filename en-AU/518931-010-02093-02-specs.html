<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Dimension</th><td>15.1" x 10.3" x 3" (38.5 cm x 26.3 cm x 7.6 cm)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>9.6 lbs (4.4 kg)</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Size</th><td>13.6" x 7.7"; 15.6" diagonal, 34.5 cm x 19.5 cm; 39.7 cm diagonal</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Resolution</th><td>1920 x 1080 pixels</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Mounting Options</th><td>Flat and flush, bail with optional accessory (Garmin does not offer any hardware or accessories for a flat-mount installation. Professional tools and knowledge is required.)</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
                <h3>Maps & Memory</h3>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum power usage at 10 Vdc</th><td>52.1W</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Traditional sonar (dual frequency/beam)</th><td>built-in (1kW dual channel CHIRP, 70/83/200 kHz, L, M, H CHIRP)</td></tr><tr>
