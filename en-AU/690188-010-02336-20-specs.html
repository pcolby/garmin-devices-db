<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Dimension</th><td>9.8" x 5.5" x 2.0" (25 x 13.9 x 5.1 cm)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>1.7 lbs (0.77 kg)</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Type</th><td>Multi-touch touchscreen WVGA display</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Size</th><td>6.1" x 3.4"; 7.0" diagonal (15.5 x 8.6 cm; 17.8 cm diagonal)</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Input</th><td>Touchscreen with Keyed Assist</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
                <h3>Maps & Memory</h3>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Accepts Data Cards</th><td><p>1 microSD card; 32 GB maximum size</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Receiver</th><td><p>5 Hz</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">LakeVu (inland)</th><td class="yes"></td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Sailing Features</th><td class="yes"></td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Power Input</th><td>9 to 18 Vdc</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Typical current draw at 12 Vdc</th><td>0.8 A</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum current draw at 12 Vdc</th><td>1.25 A</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum power usage at 10 Vdc</th><td>15W</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Power output</th><td>500 W</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">NMEA 0183 Input (Rx) Ports</th><td><p>1</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">NMEA 0183 output (Tx) ports</th><td>1</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Garmin Marine Network Ports</th><td><p>1 Panoptix™ port</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">12-pin transducer ports</th><td>1</td></tr></tbody></table></div>
