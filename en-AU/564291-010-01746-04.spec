<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Lens Material</th><td><p>chemically strengthened glass</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Physical size</th><td><p>47 x 47 x 13.9 mm</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>49 g</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Outdoor recreation</th><td><p>Hiking, Climbing, Skiing, Snowboarding, XC Classic Skiing, Stand Up Paddleboarding, Rowing, Jumpmaster, Tactical</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Heart rate from external HRM (real-time during rests, interval and session stats during rests, and automatic heart rate download post-swim)</th><td>yes (with HRM-Tri™ and HRM-Swim™)</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Toe-to-Toe™ Challenges app</th><td>Yes (optional Connect IQ app)</td></tr></tbody></table></div>
