<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Dimension</th><td>22.8" x 16.1" x 2.8" (60.0 cm x 41.0 cm x 7.1 cm)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td>18.95 lbs (8.60 kg)</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Size</th><td>20.4" x 12.8"; 24.0" diagonal, 51.8 cm x 32.5 cm; 61.0 cm diagonal</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Resolution</th><td>1920 x 1200 pixels</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Mounting Options</th><td>Flush or flat</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
                <h3>Maps & Memory</h3>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Accepts Data Cards</th><td><p>2 SD Cards (with Garmin SD card reader accesory)</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Power Input</th><td>10-35 Vdc</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Typical current draw at 12 Vdc</th><td>6.1A</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum current draw at 12 Vdc</th><td>7.6A</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum power usage at 10 Vdc</th><td>87W</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Traditional sonar (dual frequency/beam)</th><td>Yes (with external black box, sold separately)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">ClearVü</th><td>Yes (with GCV™ black box, sold separately)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">SideVü</th><td>Yes (with GCV™ black box, sold separately)</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">NMEA 0183 Input (Rx) Ports</th><td><p>4</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">NMEA 0183 output (Tx) ports</th><td>2</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Garmin Marine Network Ports</th><td><p>4</p>
</td></tr><tr>
