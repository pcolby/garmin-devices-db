<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Lens Material</th><td><p>chemically strengthened glass or sapphire crystal</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Physical size</th><td><p>42 x 42 x 15 mm</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>67 g</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Size</th><td>1.1” (27.94 mm) diameter</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Resolution</th><td>218 x 218 pixels</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Colour display</th><td class="yes"></td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Battery life</th><td>Smartwatch mode: Up to 9 days<br>GPS/HR mode: Up to 14 hours<br>UltraTrac™ mode: Up to 35 hours without wrist heart rate</td></tr><tr>
