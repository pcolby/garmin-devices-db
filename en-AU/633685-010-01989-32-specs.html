<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Physical size</th><td><p>51 x 51 x 17.5 mm</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>87 g</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Battery life</th><td>Smartwatch mode: Up to 20 days<br>GPS mode: Up to 32 hours<br>GPS + SPO2: Up to 18 hours<br>GPS + Music: Up to 13 hours<br>UltraTrac™ mode: Up to 70 hours</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Gym</th><td>Strength, Cardio and Elliptical Training, Stair Stepping, Floor Climbing, Indoor Rowing, Yoga</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Cycling</th><td><p>Biking, Mountain Biking, Triathlon</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">In-flight Pulse Ox</th><td class="yes"></td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">METAR (Meteorological Aerodrome Report)</th><td class="yes"></td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">TAF (Terminal Aerodrome Forecast)</th><td class="yes"></td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Activity history on watch</th><td class="yes"></td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Heart rate from external HRM (real-time during rests, interval and session stats during rests, and automatic heart rate download post-swim)</th><td>yes (with HRM-Tri™ and HRM-Swim™)</td></tr></tbody></table></div>
