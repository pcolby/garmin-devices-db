<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Physical size</th><td><p>45 x 45 x 15.3 mm<br />
Fits wrists with a circumference of 132-224 mm</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>52 g</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Battery life</th><td>Smartwatch mode: Up to 14 days<br>GPS mode: Up to 16 hours<br>UltraTrac™ mode: Up to 40 hours</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Gym</th><td>Strength, Cardio, Elliptical Training, Stair Stepping, Floor Climbing, Indoor Rowing</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;"> <a href="https://www.garmin.com/en-AU/garmin-technology/health-science/heart-rate-monitoring/">HR broadcast</a> (broadcasts HR data over ANT+™ to paired devices)</th><td>Yes (using ANT+)</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Sun and moon information</th><td class="yes"></td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Pool swim workouts</th><td class="yes"></td></tr></tbody></table></div>
