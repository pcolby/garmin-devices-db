<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Strap material</th><td>Titanium and silicone included</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Physical size</th><td>47 x 47 x 14.7 mm<br />Fits wrists with the following circumference:<br />Silicone band: 125-208 mm<br />Metal band: 132-215 mm</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td>120 g (49 g, case only)</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Battery life</th><td>Smartwatch mode: Up to 14 days<br />GPS mode: Up to 36 hours<br />GPS and music: Up to 10 hours<br />Max battery GPS mode: Up to 72 hours<br />Expedition GPS activity 28 days<br />Battery saver watch mode: 48 days</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Swim</th><td>Pool Swimming, Open Water Swimming</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Heart rate from external HRM (real-time during rests, interval and session stats during rests, and automatic heart rate download post-swim)</th><td>Yes (with HRM-Tri, HRM-Swim, HRM-Pro or HRM-Pro Plus)</td></tr></tbody></table></div>
