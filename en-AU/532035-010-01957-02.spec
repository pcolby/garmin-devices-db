<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Strap material</th><td><p>silicone, steel, titanium or leather</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Case material</th><td>stainless steel or titanium</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Quick Release bands</th><td>Yes (22 mm, Industry standard)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Physical size</th><td><p>49 x 49 x 15 mm</p>
</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td><p>96 g<br />
Titanium version: 76 g</p>
</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Battery life</th><td>Smartwatch mode: Up to 8 days<br>GPS mode: Up to 13 hours<br>UltraTrac™ mode: Up to 25 hours without wrist heart rate</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Connectivity</th><td>Bluetooth® Smart and ANT+®</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Measures shot distance (calculates exact yardage for shots from anywhere on course)</th><td>Manual</td></tr><tr>
