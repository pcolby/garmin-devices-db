<div><ul>
      ...
      <li>Weight: 444 g</li>
      <li><a href='https://www.garmin.com/en-AU/legal/waterrating-definitions/'>water resistance.</a>: IXP7</li>
      ...
      <li>Garmin Connect<sup>™</sup></li>
      <li>Measurement location: spindle</li>
      <li>Communication: ANT+<sup>®</sup> and Bluetooth<sup>®</sup></li>
    </ul>
    </div>
