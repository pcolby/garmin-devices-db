<div><table>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Dimension</th><td>33.0 x 22.6 x 7.9 cm</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Weight</th><td>2.6 kg</td></tr><tr>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Type</th><td>WXGA display</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Size</th><td><p>10.3" x 6.4"; 12.1" diagonal</p><p>(26.2 cm x 16.3 cm; 30.7 cm diagonal)</p></td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Display Resolution</th><td>1280 x 800 pixels</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Mounting Options</th><td>Bail or flush</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Input</th><td>Touchscreen</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
                <h3>Maps & Memory</h3>
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Accepts Data Cards</th><td>2 SD<sup>™</sup> cards; 32 GB max</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Waypoints</th><td>5,000</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Receiver</th><td>10 Hz high-sensitivity</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">ActiveCaptain Mobile Planning Compatible</th><td><p>yes</p>
</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Power Input</th><td>10 to 32 Vdc</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Typical current draw at 12 Vdc</th><td>2.4 A</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum current draw at 12 Vdc</th><td>3.0 A</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Maximum power usage at 10 Vdc</th><td>36W</td></tr></tbody></table><table>
        <tbody>
        <tr class="title">
            <td colspan="2" style="background: #fff; color: #000; border: 1px solid #ddd; border-width: 0px 0px 1px 0px; padding: 0px;">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">Traditional sonar (dual frequency/beam)</th><td>built-in (single channel CHIRP, 70/83/200 kHz, L, M, H CHIRP)</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">ClearVü</th><td>built-in 260/455/800 kHz</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">SideVü</th><td>built-in 260/455/800 kHz</td></tr><tr>
        ...
        <tr class="title">
            ...
            <th scope="row" style="background-color: #fff; font-weight: 300;">NMEA 0183 Input (Rx) Ports</th><td>1</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">NMEA 0183 output (Tx) ports</th><td>1</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Video input ports</th><td>1 BNC</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Video output ports</th><td>1 HDMI</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">J1939 ports</th><td>1</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">Garmin Marine Network Ports</th><td>2</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">12-pin transducer ports</th><td>orange</td></tr><tr>
            <th scope="row" style="background-color: #fff; font-weight: 300;">BNC external GPS antenna port</th><td class="yes"></td></tr><tr>
